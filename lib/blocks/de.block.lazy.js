...
de.Block.Lazy.prototype.clone = function() {
    return new de.Block.Lazy(
        this.ctor,
        clone_block( this.block ),
        clone_options( this.options )
    );
};
...
de.Block.Lazy.prototype.extend = function( block, options ) {
    ...
    options = ( options ) ? de.Block.extend_options( this.options, options ) : clone_options( this.options );
