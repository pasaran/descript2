...
var Fake = function( routes, config ) {
    ...
    this._server = http_.createServer( function( req, res ) {
        ...
        if ( route ) {
            ...
            response404.response( res );
        }
    } );
};

Fake.prototype.listen = function( port, hostname ) {
    if ( !this._running ) {
...
Fake.Route.prototype.response = function( res ) {
...
Fake.Answer.prototype.response = function( res ) {
